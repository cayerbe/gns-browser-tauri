import { EmailThread, EmailMessage, EmailComposeData, EmailStats, EmailAddress } from '@gns/api-core';
...
export const EmailApi = {
    ...
    async getMyAddress(): Promise<{ address: string; handle: string }> {
        ...
        try {
            ...
            // We explicitly cast headers to any to avoid typescript complaints about custom headers if strict
            const response = await fetch(`${API_BASE}/email/address`, { headers: headers as any });
